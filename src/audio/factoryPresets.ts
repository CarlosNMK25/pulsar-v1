...
export const factoryPresets: Record<string, PresetData> = {
  techno: {
    ...
    masterFilterParams: { lowpass: 1, highpass: 0, resonance: 0.1, width: 0.5 },
    bpm: 130,
    swing: 0,
  },
  ...
  ambient: {
    ...
    masterFilterParams: { lowpass: 0.8, highpass: 0.1, resonance: 0.1, width: 0.6 },
    bpm: 70,
    swing: 15,
  },
  ...
  breaks: {
    ...
    masterFilterParams: { lowpass: 1, highpass: 0, resonance: 0.15, width: 0.5 },
    bpm: 140,
    swing: 30,
  },
  ...
  experimental: {
    ...
    masterFilterParams: { lowpass: 0.7, highpass: 0.2, resonance: 0.25, width: 0.7 },
    bpm: 100,
    swing: 45,
  },
