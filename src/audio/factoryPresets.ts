...
export const factoryPresets: Record<string, PresetData> = {
  techno: {
    ...
    drumParams: { pitch: 45, decay: 55, drive: 50, mix: 85 },
    drumMuted: false,
    ...
    textureMuted: false,
    reverbParams: { size: 0.3, decay: 0.4, damping: 0.6, mix: 0.2 },
    delayParams: { time: 0.375, feedback: 0.35, filter: 0.5, mix: 0.3 },
    bpm: 130,
    swing: 0,
  },
  ...
  ambient: {
    ...
    drumParams: { pitch: 50, decay: 70, drive: 10, mix: 0 },
    drumMuted: true,
    ...
    textureMuted: false,
    reverbParams: { size: 0.9, decay: 0.85, damping: 0.3, mix: 0.6 },
    delayParams: { time: 0.5, feedback: 0.6, filter: 0.8, mix: 0.4 },
    bpm: 70,
    swing: 15,
  },
  ...
  breaks: {
    ...
    drumParams: { pitch: 55, decay: 45, drive: 60, mix: 90 },
    drumMuted: false,
    ...
    textureMuted: false,
    reverbParams: { size: 0.4, decay: 0.35, damping: 0.5, mix: 0.25 },
    delayParams: { time: 0.25, feedback: 0.5, filter: 0.6, mix: 0.35 },
    bpm: 140,
    swing: 30,
  },
  ...
  experimental: {
    ...
    drumParams: { pitch: 30, decay: 80, drive: 70, mix: 75 },
    drumMuted: false,
    ...
    textureMuted: false,
    reverbParams: { size: 0.7, decay: 0.8, damping: 0.2, mix: 0.5 },
    delayParams: { time: 0.333, feedback: 0.7, filter: 0.4, mix: 0.45 },
    bpm: 100,
    swing: 45,
  },
};
